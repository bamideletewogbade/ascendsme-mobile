...
/// - form (default) ΓÇö amount + description + date
/// - sending ΓÇö spinner
/// - saved ΓÇö success confirmation
///
...
class LogExpenseSheet extends StatefulWidget {
  ...
  /// Convenience launcher ΓÇö call from any screen.
...
class _LogExpenseSheetState extends State<LogExpenseSheet> {
  ...
  // 'cash' | 'momo' | 'bank' ΓÇö required NOT NULL on the expenses table.
  ...
  Future<void> _save() async {
    ...
    if (!appState.supabaseConfigured) {
      // Mock mode ΓÇö pretend it worked. Real apps won't hit this in production.
      setState(() {
        _saving = false;
        _saved = true;
      });
